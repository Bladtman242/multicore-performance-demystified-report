...
The state depicted above can be reached by the following sequence of actions:
\begin{enumerate}
...
\mynote{Continue writing: MESI state states, store-buffers and invalidation
queues (explanation of false sharing impact)}
