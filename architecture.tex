...
reasons, large caches -- such as the multi-kilobyte L1 caches closest to the CPU
...
multicore programming is non-trivial. As different CPU cores may store copies
